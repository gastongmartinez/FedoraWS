...
dconf write /org/gnome/shell/favorite-apps "['thunar.desktop', 'io.elementary.terminal.desktop', 'kitty.desktop', 'virt-manager.desktop', 'mozilla-thunderbird.desktop', 'org.gabmus.gfeeds.desktop', 'qalculate-gtk.desktop', 'libreoffice-calc.desktop', 'code.desktop', 'emacs.desktop', 'md.obsidian.Obsidian.desktop', 'com.jetbrains.PyCharm-Community.desktop', 'google-chrome.desktop', 'firefox.desktop', 'brave-browser.desktop', 'org.qbittorrent.qBittorrent.desktop', 'vlc.desktop']"
