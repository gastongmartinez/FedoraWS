...
git clone --single-branch --branch gnome-40 https://gitlab.gnome.org/GNOME/gnome-shell-extensions.git
# wget https://gitlab.gnome.org/GNOME/gnome-shell-extensions/-/archive/40.alpha.1/gnome-shell-extensions-40.alpha.1.zip
