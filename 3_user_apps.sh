...
git clone --depth=1 https://github.com/romkatv/powerlevel10k.git ~/.local/share/zsh/powerlevel10k
{
    ...
    echo 'if [ -f /usr/share/zsh-autosuggestions/zsh-autosuggestions.zsh ]; then'
    echo -e '\tsource /usr/share/zsh-autosuggestions/zsh-autosuggestions.zsh'
    echo 'fi'
    echo 'if [ -f /usr/share/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh ]; then'
    echo -e '\tsource /usr/share/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh'
    echo 'fi'
    echo 'if [ -f ~/.local/state/nix/profiles/profile/share/zsh-autosuggestions/zsh-autosuggestions.zsh ]; then'
    echo -e '\tsource ~/.local/state/nix/profiles/profile/share/zsh-autosuggestions/zsh-autosuggestions.zsh'
    echo 'fi'
    echo 'if [ -f ~/.local/state/nix/profiles/profile/share/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh ]; then'
    echo -e '\tsource ~/.local/state/nix/profiles/profile/share/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh'
    echo 'fi'
    ...
    echo 'export PATH="$HOME/anaconda3/bin:$HOME/.local/bin:$HOME/.yarn/bin:$HOME/.config/yarn/global/node_modules/bin:$HOME/.cargo/bin:$HOME/go/bin:$HOME/.emacs.d/bin:$PATH"'
    echo -e '\n[[ ! -f ~/.p10k.zsh ]] || source ~/.p10k.zsh'
    echo -e '\nalias nvim-go="NVIM_APPNAME=nvim-go nvim"'
